    ...
    for(int i = 0; i < ROWS; i++) {
        for(int j = 0; j < COLS; j++) {
			...
			if(j == 0){
				...
				setColor(brick, "d73b00");
			} else if(j == 2) {
				setColor(brick, "ff8901");
			} else if(j == 3) {
				setColor(brick, "ffe316");
			} else if(j == 4) {
				setColor(brick, "c0ee57");
			} else if(j == 5) {
				setColor(brick, "4b7010");
			} else if(j == 6) {
				setColor(brick, "13571a");
			} else if(j == 7) {
				setColor(brick, "1f9ac6");
			} else if(j == 8) {
				setColor(brick, "191c2b");           
            } else if(j == 9) {
				setColor(brick, "281833");           		
            }  
            add(window, brick); 
            start_x += 40; 
        }
